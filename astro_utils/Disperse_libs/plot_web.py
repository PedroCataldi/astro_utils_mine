...
def plot_crits(run, runfull, box_side_length, tracer_type, tracer_mass, persistence, snap, ax, subbox = np.array([[0, 75000], [0, 75000], [0, 75000]]), **kwargs):
	...
	crits_filepath = '/home/pcataldi/disperse_TNG/upskl_catalogues/' + run + '/' + tracer_type + '_subhalo/crits/'
	...
	# Plotting 
	ax.scatter(nmask[:,0], nmask[:,1], nmask[:,2], c='r', s=10, marker='s', **kwargs,label='crits')
	...
	return nmask, mmask, s1mask, s2mask
...
def plot_segs(run, runfull, box_side_length, tracer_type, tracer_mass, persistence, snap, ax, subbox = np.array([[0, 75000], [0, 75000], [0, 75000]]), **kwargs):
    ...
    segs_filepath = '/home/pcataldi/disperse_TNG/upskl_catalogues/' + run + '/' + tracer_type + '_subhalo/segs/'
    ...
    ax.scatter(segmask[:,0], segmask[:,1], segmask[:,2], c='k', s=2, marker='o', **kwargs,label='filaments') 
    return segmask[:,0], segmask[:,1], segmask[:,2]


def tabs_segs(run, runfull, box_side_length, tracer_type, tracer_mass, persistence, snap, subbox = np.array([[0, 75000], [0, 75000], [0, 75000]]), **kwargs):
    '''
	Given a set of parameters defining the chosen disperse run, this plots the set of 
	critical points.
...
def tabs_crits(run, runfull, box_side_length, tracer_type, tracer_mass, persistence, snap, subbox = np.array([[0, 75000], [0, 75000], [0, 75000]]), **kwargs):
	'''
	Given a set of parameters defining the chosen disperse run, this plots the set of 
	critical points.
